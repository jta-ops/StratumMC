...
public record ServerBuildInfoImpl(
    ...
    private static final String BRAND_STRATUM_NAME = "Stratum";
    ...
    private ServerBuildInfoImpl(final Manifest manifest) {
        this(
            getManifestAttribute(manifest, ATTRIBUTE_BRAND_ID)
                .map(Key::key)
                .orElse(ServerBuildInfo.BRAND_STRATUM_ID),
            getManifestAttribute(manifest, ATTRIBUTE_BRAND_NAME)
                .orElse(BRAND_STRATUM_NAME),
    ...
    public boolean isBrandCompatible(final @NotNull Key brandId) {
        return brandId.equals(this.brandId) || brandId.equals(ServerBuildInfo.BRAND_PAPER_ID);
    }
