...
dependencies {
    implementation(project(":stratum-api"))
    ...
    implementation("me.lucko:spark-stratum:1.10.152")
}
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "Stratum",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Stratum",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Stratum MC",
            "Brand-Id" to "mc.stratum:stratum",
            "Brand-Name" to "Stratum",
...
fun TaskContainer.registerRunTask(
    ...
    workingDir = rootProject.layout.projectDirectory
        .dir(providers.gradleProperty("stratum.runWorkDir").getOrElse("run"))
        .asFile
    ...
    if (providers.gradleProperty("stratum.runDisableWatchdog").getOrElse("false") == "true") {
        systemProperty("disable.watchdog", true)
    }
    systemProperty("io.papermc.paper.suppress.sout.nags", true)
    systemProperty("stratum.maxChatCommandInputSize", 32767)

    val memoryGb = providers.gradleProperty("stratum.runMemoryGb").getOrElse("2")
...
tasks.registerRunTask("runStratumclip") {
